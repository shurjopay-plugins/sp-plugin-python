from plugin.shurjopay_plugin import ShurjoPayPlugin
from plugin.model.models import *
import json
import unittest
...
class TestShurjoPayPlugin(unittest.TestCase):
    def setUp(self):
        ...
        self._make_payment = PaymentRequest(**payment_request_json)
        self._verified_payment = VerifiedPaymentDetails(
            **verified_payment_json)

    def test_make_payment(self):
        payment_details = self.plugin._make_payment(self._make_payment)
        self.assertIsInstance(payment_details, PaymentDetails,
                              "payment_details is not an instance of PaymentDetails")
        self.assertEqual(payment_details.amount, self._make_payment.amount, "amount is not equal")
        self.assertEqual(self._make_payment.currency, 'BDT', " currency  is not equal")
    ...
    def test_verify_payment(self):
        verified_payment_details = self.plugin._verify_payment(
            self._verified_payment.order_id)

        self.assertIsInstance(verified_payment_details, VerifiedPaymentDetails,
        ...
        self.assertEqual(verified_payment_details.sp_massage,
                         self._verified_payment.sp_massage, 'sp_massage is not equal')
    ...
    def test_get_payment_status(self):
        verified_payment_status = self.plugin._check_payment_status(
            self._verified_payment.order_id)
        self.assertIsInstance(verified_payment_status, VerifiedPaymentDetails,
        ...
        self.assertEqual(verified_payment_status.customer_order_id,
                         self._verified_payment.customer_order_id, 'customer_order_id is not equal')
        self.assertEqual(verified_payment_status.sp_massage,
                         self._verified_payment.sp_massage, 'sp_massage is not equal')
