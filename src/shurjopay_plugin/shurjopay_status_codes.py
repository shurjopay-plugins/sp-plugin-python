...
OTP_MISSMATCH = (
    "1006", "OTP is not matched during mobile wallet transaction.")
PIN_MISSMATCH = (
    "1007", "Verification PIN is not matched during mobile wallet transaction.")
INSUFFICIENT_BALANCE = ("1008", "Insufficient balance to pay the amount.")
DAILY_LIMIT = (
    "1009", "Shurjopay daily transaction's limit has been exceeded.")
CURRENCY_MISSMATCH = ("1010", "Shurjopay accepts BDT and USD currency.")
INVALID_ORDER_ID = (
    "1011", "Invalid order id. Provide shurjopay valid order id.")
BKASH_DUPLICATE_PAYMENT = (
    "1061", "Bkash does not allow same payment transaction within 10 minutes.")
AUTHENTICATION_FAILED = (
    "1064", "Shurjopay merchants authentication failed. Check username and password!")
...
INACTIVE_MERCHANT = (
    "2008", "Merchant is inactive. Contact with your respective KAM.")
BKASH_DEBIT_PARTY = (
    "2009", "Payment has failed debit party identity tag prohibits execution.")
