...
from plugin.model.models import PaymentRequest, VerifiedPaymentDetails, PaymentDetails
import unittest
import json
...
class TestShurjoPayPlugin(unittest.TestCase):
    ...
    def test_make_payment(self):
        ...
        self.assertEqual(payment_details.currency,
                         self._make_payment.currency, "currency is not equal")
